            ...
            {isAdvancedOpen && (
              <div className="mt-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="width" className="flex items-center text-sm font-medium text-gray-900 mb-3">
                      <img src="/form/width.svg" alt="Width" className="w-5 h-5 mr-2 text-gray-900 [&>path]:fill-current" />
                      {t('form.width.label')}
                    </label>
                    ...
                    <p className="mt-2 text-sm text-gray-600/80">{t('form.width.hint')}</p>
                    {sizeError && (
                  ...
                  <div>
                    <label htmlFor="height" className="flex items-center text-sm font-medium text-gray-900 mb-3">
                      <img src="/form/height.svg" alt="Height" className="w-5 h-5 mr-2 text-gray-900 [&>path]:fill-current" />
                      {t('form.height.label')}
                    </label>
                    <div className="relative flex items-center bg-white/50 backdrop-blur-sm border border-amber-400/40 rounded-xl focus-within:ring-2 focus-within:ring-amber-400/50 focus-within:border-amber-400/50 shadow-inner transition-all duration-300">
                      <input
                    ...
                    <p className="mt-2 text-sm text-gray-600/80">{t('form.height.hint')}</p>
                    {sizeError && (
                      <p className="mt-1 text-sm text-red-400">{sizeError}</p>
                    )}
                  </div>
                ...
                {uploadedImages.length > 0 && (
                  <div>
                    <label htmlFor="denoising_strength" className="flex items-center text-sm font-medium text-gray-900 mb-3">
                      <img src="/form/denoise.svg" alt="Denoising Strength" className="w-5 h-5 mr-2 text-gray-900 [&>path]:fill-current" />
                    ...
                    <p className="mt-2 text-sm text-gray-600/80">{t('form.denoising_strength.hint')}</p>
                  </div>
                )}
              </div>
            )}
