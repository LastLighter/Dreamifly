...
export default function TencentAds() {
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      window.TencentGDT.push({
        app_id: '1211628599', // {String} - appid - 必填
        placement_id: '8232358642752084', // {String} - 广告位id - 必填
        ...
        onComplete: function(res: any) {
          if (res && res.constructor === Array) {
            ...
            setTimeout(() => {
              if (window.TencentGDT?.NATIVE) {
                window.TencentGDT.NATIVE.loadAd('8232358642752084')
              }
            }, 3000)
          }
        }
